        ...
        <div class="container">
            <div class="main__product-content">
                <h3 class="main__product-content-title"> Добавление товара </h3>
                    <Form class="Product" name="Product-form" method="POST" action={{route("goodsEdit")}}> 
                    @csrf   
                    <div class="Product__inner Product_creater" style="    resize: none; " >
                            ...
                            <textarea class="product__description" placeholder="описание" rows="8" cols="25" name="description" style="margin-top:10px; resize:none;"></textarea>
                        </div>

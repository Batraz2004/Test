        ...
        <div class="container">
            <div class="main__product-content">
                <h3 class="main__product-content-title"> Добавление товара </h3>
                    <Form class="product__creater-form" name="product-form" method="POST" action="{{route("goodsCreate")}}">
                    @csrf   
                    <div class="product__creater-form__inner product__creater">
                        ...
                        <button type="submit" class="product__button" name="edit-id" value=""><p>Сохранить</p></button>
                    </Form>
            </div>
        </div>
    </section>
